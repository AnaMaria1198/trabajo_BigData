...
El documento con el código para hacer mi trabajo se encuentra en el archivo `Informe.Rmd` del repo. La versión final del trabajo puede visualizarse en: <https://AnaMaria1198.github.io/trabajo_BigData/>.
